...
const Hero = () => {
    ...
    return (
        <section id="Hero" className="relative pt-24 md:pt-0 max-h-screen">
            {/* <i className="fab fa-react text-white font-bold text-[20rem] absolute -translate-x-[50%] -translate-y-[50%] left-[50%] top-[50%] opacity-0 md:opacity-100"></i> */}
            {/* <i className="fab fa-python font-bold text-[12rem] absolute opacity-10 left-[8%] bottom-[10%]"></i> */}
            <div id="Hero__container" className="h-full md:grid md:grid-cols-2 grid-rows-2 flex flex-col-reverse justify-center items-center mx-auto md:gap-5 px-4 md:px-0 ">
                <div className=" xl:pt-[8rem] lg:pt-[8rem] md:pt-[12rem] pt-8 text-center flex items-center justify-center flex-col h-full px-1 py-2">
                    <div className=" max-w-[32.5rem]">
                        ...
                        <motion.div
                            initial="initial"
                            animate= {{...sharedVariants.animate,
                ...
                <div className="md:bg-primary md:flex flex-col items-center justify-center h-full">
                    <div className="bg-primary rounded-[50%] md:h-[65%] h-[18rem] px-10 py-10 shadow-xl md:px-0 md:py-0 md:shadow-none">
                        <img src={data.ImageURL} alt="my-image" className="h-full"/>
                    </div> 
                </div>
            </div>
        </section>
